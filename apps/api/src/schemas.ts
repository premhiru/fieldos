...
export const whatsappRecommendationSettingSchema = z
  .object({
  ...
  .refine(
    (setting) => Boolean(setting.quietHoursStart) === Boolean(setting.quietHoursEnd),
    "Quiet-hours start and end must both be provided."
  );
